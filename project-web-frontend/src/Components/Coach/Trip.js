                    ...
                    <div className={styles.tripRoute}>
                        ...
                        <div className={styles.tripRouteInfo}>
                                <div className={styles.contentTrip}>
                                    <div style={{color: "#484848", fontSize: "20px", fontWeight: "bold"}}>{trip.startTime}</div>
                                    <div class="place">• {trip.startPlace}</div>
                                </div>
                                <div style={{color: "#A1A1A1"}}>{tripTime}</div>
                                <div className={styles.contentTrip}>
                                    <div style={{color: "#707070", fontSize: "20px", fontWeight: "bold"}}>{trip.endTime}</div>
